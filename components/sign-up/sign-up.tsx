                ...
                {session ? (
                    <div className="flex flex-col w-full justify-center gap-8">
                        <h2 className="w-full text-center">
                            ...
                            {/* TODO: Change this placeholder with a tailwind component */}
                        ...
                        <button
                            ...
                            className="w-fit mx-auto rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 cursor-pointer"
                        >
                            Sign out
                        </button>
                    </div>
