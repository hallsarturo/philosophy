...
export default function Parallax({ courseData }: ParallaxProps) {
    ...
    const backgroundY = useTransform(scrollY, [0, 1000], [0, -500]); // slowest
    const textY = useTransform(scrollY, [0, 1000], [0, -1600]); // medium
    const dummyMapY = useTransform(scrollY, [0, 1000], [0, -3200]); // fastest
                ...
                <div className="bg-white py-6 sm:py-8 dark:bg-gray-900">
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-scroll bg-no-repeat z-0"
                        >
